import{foodItem} from './item4.js'

console.log(foodItem);
function displayItems(){
    var Cleaning=document.getElementById('Cleaning');
    var Pestcontrol=document.getElementById('Pestcontrol');
    const CleaningData= foodItem.filter(item=> item.category=='Cleaning');
    console.log(CleaningData);
    const PestcontrolData= foodItem.filter(item=> item.category=='Pestcontrol');
    console.log(PestcontrolData);
    ...
    PestcontrolData.map(item=>{
        ...
        Pestcontrol.appendChild(itemCard)
    })
}
displayItems();
